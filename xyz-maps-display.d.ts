...
declare class Map_2 {
     ...
     */
    setViewBounds(bounds: GeoRect | [number, number, number, number] | GeoJSONFeature | GeoJSONFeature[] | GeoJSONFeatureCollection): void;
    /**
     ...
     */
    addLayer(layer: TileLayer, index?: number): void;
    /**
     ...
     */
    refresh(layers?: TileLayer | TileLayer[]): void;
    /**
